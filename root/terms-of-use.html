...
<body>
    ...
    <div class="container">
        ...
        <p>
        <h2>Introduction</h2>
        <p>This online educational platform provides innovative methods of learning and assessment. By using this
            platform, you agree to these terms.</p>
        </p>
        <p>
            <br>
        <h2>User Responsibilities</h2>
        <p>Users are expected to maintain the integrity of their accounts and interact respectfully with all content.
        </p>
        </p>
        <p>
            <br>
        <h2>Content Guidelines</h2>
        <p>Content should be educational and relevant to language and programming learning. Respect for copyright and
            intellectual property is mandatory.</p>
        </p>
        <p>
            <br>
        <h2>Use of the Platform</h2>
        <p>The platform should be used for educational purposes only. Any misuse of resources and services is strictly
            prohibited.</p>
        </p>
        <p>
            <br>
        <h2>Disclaimer of Warranties</h2>
        <p>The platform is provided "as is" without any guarantees of service uptime or data accuracy.</p>
        </p>
        <p>
            <br>
        <h2>General Provisions</h2>
        <p>These terms are governed by the applicable laws and any disputes will be resolved through arbitration.</p>
        </p>
    </div>
