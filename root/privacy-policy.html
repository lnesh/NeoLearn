...
<body>
    ...
    <nav class="navbar sticky-top" style="background-color:#492a6c; border-radius: 50px; margin: 20px;">
        <div class="container-fluid">
            ...
            <form action="./backend/search.php" method="GET" style="display: flex; gap: 18px;">
                <input class="form-control" name="search" style=" border-radius: 25px; border: 1px solid #492a6c; " type="search"
                    placeholder="Search" aria-label="Search">
                <button class="btn" name="search-submit" style=" background-color: #492a6c; color: aliceblue; border-radius: 25px;"
                    type="submit"><svg style="width:30px; height:30px; " class=" text-purple-800 dark:text-purple"
    ...
    <div class="container">
        ...
        <div style="text-align: center;">
            <img src="./media/NeoLearnLogo.png" width="200" alt="Neolearn logo" style="align-self: center;">
        </div>

        <h1>Privacy Policy</h1>
        <p>
        <h2>Introduction</h2>
        <p>This Privacy Policy outlines how we collect, use, and protect your data on our online educational platform.
        </p>
        </p>
        <br>
        <p>
        <h2>Information Collection</h2>
        <p>We collect various types of information, including personal details and usage data, to enhance your
            experience on our platform.</p>
        </p>
        <br>
        <p>
        <h2>Use of Information</h2>
        <p>The information collected is used for account management, service improvement, and as described in this
            policy.</p>
        </p>
        <br>
        <p>
        <h2>Data Sharing and Disclosure</h2>
        <p>We may share your data under certain circumstances, such as legal requirements or with your consent.</p>
        </p>
        <br>
        <p>
        <h2>Data Security</h2>
        <p>We take measures to protect your data from unauthorized access, alteration, and destruction.</p>
        </p>
        <br>
        <p>
        <h2>User Rights</h2>
        <p>You have rights regarding your data, including access and correction.</p>
        </p>
        <br>
        <p>
        <h2>Cookies and Tracking Technologies</h2>
        <p>We use cookies and similar technologies to enhance your experience and gather usage data.</p>
        </p>
        <br>
        <p>
        <h2>Policy Updates</h2>
        <p>Any changes to our privacy practices will be updated in this policy.</p>
    </div>
