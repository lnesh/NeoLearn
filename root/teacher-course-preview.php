...
<body>
    ...
    <nav class="navbar sticky-top" style="background-color:#492a6c; border-radius: 50px; margin: 20px;">
        <div class="container-fluid">
            ...
            <form style="display: flex; gap: 18px;"><input class="form-control"
                    style=" border-radius: 25px; border: 1px solid #492a6c; " type="search" placeholder="Search"
                    ...
                    </svg></button></form><button class="navbar-toggler" type="button" data-bs-toggle="offcanvas"
